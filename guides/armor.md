...
<h3 id="костюмы" class="toc-header"><a class="toc-anchor" href="#костюмы">¶</a> Костюмы</h3>
<div class="table-with-III-columns">
  <div class="table-title">Броня</div>
  <div class="table-title">Характеристики</div>
  <div class="table-title">Описание</div>
...
<div class="table-item button med">
    <img src="/armor/wintercoatgenetics.png">
...
<div class="table-item">
  ...
  <div class="table-item">Бронированный плащ синдиката с позолоченными узорами.</div>
  <div class="table-item button antag">
...
<div class="table-with-IV-columns">
  ...
  <div class="table-item">Защитный скафандр, используемый оперативниками отряда быстрого реагирования.</div>
  <div class="table-item button cent">
    <img src="/armor/ertsecurityhardsuitnew.png">
...
<div class="table-with-IV-columns">
  ...
  <div class="table-item">Специальный костюм, защищающий от опасной среды с низким давлением. Имеет тепловую защиту. Отличается от своих новых версий облегчённой конструкцией,а так же отсутствием части защитных пластин.</div>
  <div class="button"></div>
</div>
...
<div class="table-with-III-columns">
  ...
  <div class="table-item button sec">
    <img src="/armor/mercenaryhelmet.png">
    Шлем наёмника
  </div>
  <div class="table-item">
    <span> - <b class="type">Тупой</b> урон снижается на <b class="percent">10%</b></span>
  ...
  <div class="table-item">Обычный шлем сотрудника Службы Безопасности.</div>
  <div class="table-item button cent">
    <img src="/armor/ertjanitorhelmet.png">
    Шлем уборщика ОБР
  </div>
  <div class="table-item">
    <span> - <b class="type">Тупой</b> урон снижается на <b class="percent">10%</b></span>
  ...
  <div class="table-item">Шлем для работы в атмосфере, который носят уборщики группы экстренного реагирования Nanotrasen. Имеет фиолетовые блики.</div>
  <div class="table-item button cent">
    <img src="/armor/ertmedhelmet.png">
    Шлем медика ОБР
  </div>
  <div class="table-item">
    <span> - <b class="type">Тупой</b> урон снижается на <b class="percent">10%</b></span>
  ...
  <div class="table-item">Шлем для работы в атмосфере, который носят медики группы экстренного реагирования Nanotrasen. Имеет белые блики.</div>
  <div class="table-item button cent">
    <img src="/armor/ertenghelmet.png">
    Шлем инженера ОБР
  </div>
  <div class="table-item">
    <span> - <b class="type">Тупой</b> урон снижается на <b class="percent">10%</b></span>
  ...
  <div class="table-item">Шлем для работы в атмосфере, который носят инженеры группы экстренного реагирования Nanotrasen. Имеет оранжевые блики.</div>
  <div class="table-item button cent">
    <img src="/armor/ertsecurityhelmet.png">
    Шлем сотрудника безопасности ОБР
  </div>
  <div class="table-item">
    <span> - <b class="type">Тупой</b> урон снижается на <b class="percent">10%</b></span>
    <span> - <b class="type">Рубящий</b> урон снижается на <b class="percent">10%</b></span>
  ...
  <div class="table-item">Шлем для работы в атмосфере, который носят сотрудники безопасности группы экстренного реагирования Nanotrasen. Имеет красные блики.</div>
  <div class="table-item button cent">
    <img src="/armor/ertleaderhelmet.png">
    Шлем лидера ОБР
  </div>
  <div class="table-item">
    <span> - <b class="type">Тупой</b> урон снижается на <b class="percent">10%</b></span>
  ...
  <div class="table-item">Шлем для работы в атмосфере, который носит лидер группы экстренного реагирования Nanotrasen. Имеет синие блики.</div>
  <div class="table-item button antag">
    <img src="/armor/specopssyndicate.png">
    Шлем спецназа синдиката
  </div>
  <div class="table-item">
    <span> - <b class="type">Тупой</b> урон снижается на <b class="percent">20%</b></span>
    <span> - <b class="type">Рубящий</b> урон снижается на <b class="percent">20%</b></span>
  ...
  <div class="table-item">Чрезвычайно прочный шлем, который часто используется военизированными формированиями. Сверху нарисован логотип Синдиката. Является контрабандой.</div>
  <div class="table-item button antag">
    <img src="/armor/culthelmet.png">
    Шлем культа
  </div>
  <div class="table-item">
    <span> - <b class="type">Тупой</b> урон снижается на <b class="percent">10%</b></span>
  ...
  <div class="table-item">Крепкий злобно выглядящий шлем культа.</div>
  <div class="table-item button other">
    <img src="/armor/spacesuithelmet.png">
    Шлем скафандра
  </div>
  <div class="table-item">
    <span> - <b class="type">Тупой</b> урон снижается на <b class="percent">10%</b></span>
  ...
  <div class="table-item">Надёжный крепкий шлем для борьбы с существами из преисподней.</div>
  <div class="table-item button other">
    <img src="/armor/chitinhelmet.png">
    Хитиновый шлем
  </div>
  <div class="table-item">
    <span> - <b class="type">Тупой</b> урон снижается на <b class="percent">20%</b></span>
  ...
  <div class="table-item">Тело генокрада раздувается, создавая крепкую оболочку в Броне шлема.</div>
  <div class="table-item button other">
    <img src="/armor/watermelonhelmet.png">
    Арбузный шлем
  </div>
  <div class="table-item">
    <span> - <b class="type">Тупой</b> урон снижается на <b class="percent">5%</b></span>
  </div>
  <div class="table-item">Небрежно разрезанная половинка арбуза, выпотрошенная изнутри, для ношения в качестве шлема. Это может смягчить удар по голове.</div>
  <div class="button"></div>
</div>
<h2 id="маски" class="toc-header"><a class="toc-anchor" href="#маски">¶</a> Маски</h2>
<div class="table-with-III-columns">
  <div class="table-title">Броня</div>
  <div class="table-title">Характеристики</div>
  <div class="table-title">Описание</div>
  <div class="table-item button other">
    <img src="/armor/militarymask.png">
    Медицинская маска военного стиля
  </div>
  <div class="table-item">
    <span> - <b class="type">Тупой</b> урон снижается на <b class="percent">5%</b></span>
    <span> - <b class="type">Рубящий</b> урон снижается на <b class="percent">5%</b></span>
  ...
  <div class="table-item">Маска с небольшой защитой. Изготовлена в стиле маски, которая использовалась в медицинских частях первой корпоративной войны.</div>
  <div class="table-item button sec">
  ...
  <div class="table-item">Стандартный противогаз СБ.</div>
  <div class="table-item button sec">
    <img src="/armor/mercenarygasmask.png">
    Противогаз наёмника
  </div>
  <div class="table-item">
    <span> - <b class="type">Тупой</b> урон снижается на <b class="percent"> 10%</b></span>
  ...
  <div class="table-item">Противогаз в желтоватой окраске в слегка устаревшем стиле.</div>
  <div class="table-item button sec">
  ...
  <div class="table-item">Элитный защитный противогаз.</div>
  <div class="table-item button cargo">
  ...
  <div class="table-item">Противогаз армейского класса. Обычно его используют утилизаторы.</div>
  <div class="table-item button eng">
    <img src="/armor/atmosgasmaskfix.png">
    Атмос-противогаз
  </div>
  <div class="table-item">
    <span> - <b class="type">Тепловой</b> урон снижается на <b class="percent">20%</b></span>
  </div>
  <div class="table-item">Противогаз из специального материала, который даёт небольшую защиту.</div>
  <div class="table-item button com">
    <img src="/armor/captaingasmaskfix.png">
    Противогаз капитана
  </div>
  <div class="table-item">
    <span> - <b class="type">Тепловой</b> урон снижается на <b class="percent">20%</b></span>
  </div>
  <div class="table-item"><span>Почётный противогаз <a href="/roles/captain" class="is-internal-link is-valid-page">капитана</a>. На самом деле перекрашенный атмос-противогаз.</span></div>
  <div class="table-item button cent">
    <img src="/armor/centcomgasmaskfix.png">
    Противогаз Центком
  </div>
  <div class="table-item">
    <span> - <b class="type">Тепловой</b> урон снижается на <b class="percent">20%</b></span>
  </div>
  <div class="table-item"><span>Ещё более почётный противогаз <a href="/roles/representativeofcc" class="is-internal-link is-valid-page">представителей ЦК</a>. Тот же перекрашенный атмос-противогаз.</span></div>
  <div class="table-item button cent">
    <img src="/armor/ertgasmask.png">
    Противогаз ОБР
  </div>
  <div class="table-item">
    <span> - <b class="type">Тупой</b> урон снижается на <b class="percent">5%</b></span>
  ...
  <div class="table-item">Элитный противогаз отряда ОБР.</div>
  <div class="table-item button cent">
    <img src="/armor/deathsquadgasmask.png">
    Противогаз отряда смерти
  </div>
  <div class="table-item">
    <span> - <b class="type">Тупой</b> урон снижается на <b class="percent">20%</b></span>
    <span> - <b class="type">Рубящий</b> урон снижается на <b class="percent">20%</b></span>
  ...
  <div class="table-item">Элитный противогаз для особых сил NT.</div>
  <div class="button"></div>
</div></div>