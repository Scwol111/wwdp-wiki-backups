...
description: 
published: true
date: 2025-10-23T17:06:24.008Z
tags: атмос, инженерный, руководство
editor: markdown
...
<h1>Устройства работы с газами</h1>
...
<tbody>
<tr>
<td><img src="/pipes/pipestraight.png" alt="Прямая труба"></td>
<td>Прямая труба</td>
<td>Прямой сегмент трубы.</td>
</tr>
<tr>
<td><img src="/pipes/pipebend.png" alt="Угловая труба"></td>
<td>Угловая труба</td>
<td>Угловой сегмент трубы.</td>
</tr>
<tr>
<td><img src="/pipes/pipetjunction.png" alt="Т-образная труба"></td>
<td>Т-образная труба</td>
<td>Сегмент трубы с 3 путями.</td>
</tr>
<tr>
<td><img src="/pipes/pipefourway.png" alt="Четверная труба"></td>
...
<h3>Стандартный насос</h3>
<img src="/pipes/pumppressure.png" class="deviceFour" id="anchor_pressure_pump">
<p><img src="/pipes/pumppressureui.png" alt="Стандартный насос"></p>
...
<h3>Объемный насос</h3>
<img src="/pipes/pumpvolume.png" class="deviceFour" id="anchor_volume_pump">
<p><img src="/pipes/pumpvolumeui.png" alt="Объемный насос"></p>
...
<tbody>
<tr>
<td><img src="/pipes/pumpmanualvalve.png" alt="Ручной клапан"></td>
<td>Ручной клапан</td>
<td>Можно открывать и закрывать рукой.</td>
</tr>
<tr>
<td><img src="/pipes/pumpsignalvalve.png" alt="Сигнальный клапан"></td>
...
<h2>Газовый смеситель</h2>
<img src="/pipes/gasmixer.png" class="deviceFour" id="anchor_mixer">
<p><img src="/pipes/gasmixerui.png" alt="Газовый смеситель"></p>
...
<p><img src="/pipes/gasfilterui.png" alt="Газовый фильтр"></p>
...
<h2>Вентиляция</h2>
<img src="/pipes/vent_off.png" class="deviceFour" id="anchor_vent"  alt="Вентиляция">
...
<h2>Скруббер</h2>
<img src="/pipes/scrub_off.png" class="deviceFour" id="anchor_scrubber" alt="Скруббер">
...
<h2>Инжектор</h2>
<img src="/pipes/injector.png" class="deviceFour" alt="Инжектор">
...
<h2>Пневматический клапан</h2>
<img src="/pipes/pneumaticvalve.png" class="deviceFour" id="anchor_pneumatic_valve" alt="Пневматический клапан">
...
<p><img src="/pipes/300px-pressure_relief_system(rus).png" alt="Клапан сброса давления"></p>
...
<h3>Если вам всё ещё не понятно</h3>
<p>Как работает пневматический Клапан <a href="https://github.com/space-wizards/space-station-14/pull/10520">atmos turing-complete</a>.</p>
<h2>Соединительный порт</h2>
<img src="/pipes/gascanisterport.png" class="device" id="anchor_port" alt="Соединительный порт">
...
<p><img src="/pipes/canisterui.png" alt="Канистра"></p>
...
<h2>Газодобытчик</h2>
<img src="/pipes/gasminer.png" class="device" id="anchor_gasminer" alt="Газодобытчик">
...
<h2>Радиатор</h2>
<img src="/pipes/hestraight.png" class="deviceFour" id="anchor_radiator" alt="Радиатор"><div>
...
<h2>Конденсатор</h2>
<img src="/pipes/condenser.png" class="device" id="anchor_condenser" alt="Конденсатор"><div>
...
<h1>Датчик воздушной тревоги</h1>
...
<p><img src="/pipes/air-alarm.png" alt="Датчик воздушной тревоги"></p>
<ul>
...
<h3>Настройка вентиляций</h3>
<p><img src="/pipes/airalarmventuinew.png"></p>
<ul>
...
<h3>Настройка скрубберов</h3>
<p><img src="/pipes/airalarmscrubuinew.png"></p>
<ul>
<li>Красная секция - название устройства и статус его работы. Название также можно увидеть, осмотрев устройство, чтобы точно удостовериться, что вы работаете с нужным вам оборудованием. Если снять галочку, то можно выключить устройство.</li>
...
<h3>Режимы</h3>
<p><img src="/pipes/airalarmdownui.png"><br>
...
<h1>Термоэлектрический генератор</h1>
<center>
<img src="/pipes/tegfull.png">
</center>
...
<td>Кислород (O2)</td>
<td>Является одним из побочных продуктов <a href="/guides/supermatter">суперматерии</a>, при поглощении ею газа. На станции присутствует его газодобытчик.</td>
...
<td>0</td>
<td>Не имеет</td>
<td>Так как не способствует возгоранию, находится в лёгком доступе на станции и имеет относительно высокую теплоёмкость, является одним из самых безопасных газов, используемых в охлаждении <a href="/guides/supermatter">суперматерии</a>. Является частью микса для дыхания на станции (20% Кислорода на 80% Азота).</td>
</tr>
<tr>
...
<td>Плазма</td>
<td>Является одним из побочных продуктов <a href="/guides/supermatter">суперматерии</a>.</td>
