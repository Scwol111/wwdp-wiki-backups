...
<center>
 ...
 <!---   <tr>
    ...
    <tr>
      ...
      <td>2 ТК</td>
      <td>
        <p>Позволяет поставить себе любую должность (даже которой не существует), любую иконку должности для и любое имя. Изменить имя и должность можно в любой момент.</p>
