...
description: 
published: true
date: 2025-12-21T22:12:15.927Z
tags: 
editor: markdown
dateCreated: 2024-09-10T19:07:43.345Z
---

<!-- Таблица с типами чата (Без изменений) -->
<table id="info-table">
  <tr>
...
<p id="warn" class="t-red infobox danger-custom" style="margin: 20px;"><b>ДЛЯ ИГРЫ НА СЕРВЕРАХ WWDP ВАМ ДОЛЖНО <b>БЫТЬ НЕ МЕНЕЕ 16 ЛЕТ</b>. ПОЛЬЗОВАТЕЛИ, ПОДОЗРЕВАЕМЫЕ В ТОМ, ЧТО ИМ МЕНЬШЕ 16 ЛЕТ, БУДУТ ЗАБЛОКИРОВАНЫ ДО ДОСТИЖЕНИЯ ИМИ УСТАНОВЛЕННОГО ПРАВИЛАМИ СЕРВЕРА ВОЗРАСТА.</b></p>

<!-- НАЧАЛО ВКЛАДОК WIKI.JS -->
# Правила Серверов {.tabset}

## Europa (Medusa)

<!-- Контейнер стилей Europa -->
<div class="rule-container">
<p class="desc-med"><span class="medusa-text">SS14 [Europa]</span> - это ролевая игра про хаос на космической станции, где вы отыгрываете персонажа, который в любой момент может стать жертвой событий или наоборот - героем. Используйте механики игры и работайте сообща с другими игроками чтобы создавать увлекательные и неповторимые истории в сеттинге мрачного корпоративного будущего.
</p>
...
<!-- Контейнер стилей Reserve -->
<div class="rule-container">
<p class="desc-reserve"><span class="reserve-text">SS14 [Reserve]</span> - здесь действуют правила Резервной Станции. Ниже приведен основной свод, который может дополняться спецификой сервера.
</p>

<div class="infobox warning-custom">
Если в ходе игры у вас возникли вопросы по правилам, воспользуйтесь админ-помощью, нажав F1.
</div>
    
<ol class="rule-list-custom">
<li>Основные положения Reserve</li>
  <ul class="ul-in-list">
   На этом сервере действуют те же базовые принципы адекватности, но могут быть послабления или ужесточения в зависимости от режима.<br><br>
   <span style="color: #ff0000;">Гриф и намеренная порча игры по-прежнему запрещены.</span>
  </ul>

<li>Взаимодействие и Ролеплей</li>
  <ul class="ul-in-list">
    Ожидается соблюдение ролей, однако требования к "High RP" могут быть снижены в угоду динамике (если это предусмотрено режимом).<br><br>
    Запрещен выход из роли (OOC в IC) и использование сленга (Брейнрот).
  </ul>

<li>Метагейм и Информация</li>
  <ul class="ul-in-list">
     <span class="t-red">Правила касательно метагейма (получения информации извне) остаются строгими.</span> Не используйте дискорд для координации.
  </ul>
  
<li>Антагонисты</li>
  <ul class="ul-in-list">
    Антагонисты обязаны создавать интересную ситуацию, а не просто уничтожать всё живое (если цель не гласит обратное).
  </ul>

<li>ERP и Читы</li>
  <ul class="ul-in-list">
    <span class="t-red">Использование стороннего ПО и ERP строго запрещены.</span>
  </ul>
</ol>
</div>