...
<div class="table">
  ...
  <div class="table-item">
    <span>Неиссякаемый источник энергии, требует замены топлива в коллекторах радиации. Питается частицами создаваемыми УЧ. Подробнее о его настройке можно прочитать в руководстве <a href="https://js.ss14.su/guides/singularengine">Сингулярный двигатель</a></span>
  </div>
   <!-- Суперматерия -->
  <div class="table-item">
