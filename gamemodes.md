...
<div class="content">
<p><strong>Расширенный</strong> - это запасной режим игры, выбираемый в результате невозможности выбора режима из-за нехватки игроков. В расширенном режиме нет каких-либо антагонистов, кроме <a href="/guides/events" class="is-internal-link is-valid-page">обычных случайных событий</a>.</p>
</div><div>
