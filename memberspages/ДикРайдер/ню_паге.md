...
<button class="collapsible" type="button">
    ...
    <h2 class="toc-header" id="десять-заповедей" style="color: white; margin: 0 10px;"><a href="#десять-заповедей" class="toc-anchor">¶</a> Десять заповедей</h2>
    <img src="/roles/synthetics/ai_/aiscreegod.gif">
</button>
<div class="content">
<ol>
