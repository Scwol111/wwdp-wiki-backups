...
<div class="rules-section">
  ...
  <div class="rules-list">
    ...
    <div class="rule-item">
      ...
      <div class="rule-content">
        <h3 class="rule-header">Убийство заключённого без причины</h3>
        <p>
    ...
    <div class="rule-item">
      ...
      <div class="rule-content">
        <h3 class="rule-header">Саботажники</h3>
        <p>
    ...
    <div class="rule-item">
      ...
      <div class="rule-content">
        <h3 class="rule-header">Изъятие оружия после игр</h3>
        <p>
