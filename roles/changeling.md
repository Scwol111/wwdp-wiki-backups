...
<p style="str"> <b>Задачи</b>: Генокрад обязан поглотить как можно больше людей и украсть некоторые вещи для синдиката. Список целей можно посмотреть <a href="#task-types">Виды заданий</a>
.</p> 
