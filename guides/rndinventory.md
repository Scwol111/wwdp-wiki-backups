...
Каждая часть РНД из списка очень важна для функционирования не только отдела, но и всей станции, а если точнее, ее целостности. Но для их работы может понадобиться парочка предметов доступных к просмотру ниже.
