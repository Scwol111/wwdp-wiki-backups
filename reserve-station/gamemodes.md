...
<div class="content">
<p><strong>Гриншифт</strong> - Это режим, который буквально олицетворяет спокойствие, где не может быть рандомизированных событий, антагонистов. Но помните, в этой игре, страшны только пассажиры. 
Его можно выбрать в голосовании. И поставлен он может быть админами, частично, для проведения ивентов
</div>
