...
Чтобы начать операцию, нажмите <kbd>ПКМ</kbd> на пациенте и выберите в контекстном меню пункт <i><b>Начать операцию</b></i>. Затем выберите нужную часть тела и тип операции - все легко и просто!
