...
# Научный инвентарь
  В игре существует несколько отделов, каждый из которых выполняет свою роль в функционировании станции. Одним из таких отделов является РНД, или же отдел исследований. Его инвентарь можно разделить на несколько отраслей: 
...
<table class="table-name">
  <thead>
    ...
    <tr>
      ...
      <td>Инструмент, создающий порталы при использовании. <p> При первом использовании создает <span style="color: orange;">оранжевый</span> портал. <p> При втором использовании создает <span style="color: #2176ff;">синий</span> портал.<p> При третьем использовании <span style="color: red;">удаляет</span> два предыдущих портала.</td>
    </tr>
    <tr>
