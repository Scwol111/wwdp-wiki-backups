...
skaner_uslov.gif"> </td>
    ...
    <tr>
      <td>Артефакты</td>
      <td>Артефакты - источник знаний и веселья для вашего отедела. Только с ними вы можете создать сингулярность из броска или взрыв из капли крови!</td>
      <td>Артефакты нужны ученым для извлечения из них очков исследований путем исследования узлов артефакта. На большинстве станций вы можете встретить по 2 артефакта на отдел. <p> Могут быть заказаны в карго</td>
    </tr>
  </tbody>
</table>
...
anomaly-sync.png"></td>
    ...
    <tr>
      <td><strong>Аномалии</strong></td>
      <td>Аномалии это одновременно и источник очков, и источник проблем для вашей станции!</td>
      <td>Исследование или уничтожение аномалий - ваша цель, как ученого, по этому для них было придумано множество технологий, упрощающих взаимодействие с ними. </td>
    </tr>
  </thead>
  <tbody>
</table>
...
<table class="table-name">
  <thead>
    ...
    <tr>
      <td><strong>Борги</strong></td>
      <td>Рабы? Нет! Это же ваши обычные прислуги!</td>
...
tinfold_hat.png"></strong></td>
      ...
      <td>Слабая защита от псионических способностей, защищает от слабых способностей и превращается в пыль от сильных. <p>Может быть получена из ОдеждоМата или создана из 1 стали в крафт меню.</td>
    </tr>
    <tr>
