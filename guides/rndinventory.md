...
# Научный инвентарь
  В игре существует несколько отделов, каждый из которых выполняет свою роль в функционировании станции. Одним из таких отделов является РНД или же <a href="ru/roles/scientificdepartment">отдел исследований</a>. Его инвентарь можно разделить на несколько отраслей: 
1. <a href="/ru/guides/xenoarcheology">Ксеноархеология</a>. Наука о артефактах и все что с ними связано.
...
4. <a href="/ru/guides/psionics">Псионика</a>. Наука об пси способностях, получении выгоды из них и их ликвидации при опасности для экипажа.
...
skaner_uslov.gif"><p><strong>Сканер узлов</strong><p> </td>
      ...
      <td>При использовании на артефакте дает текущий узел. Можно использовать для более быстрого исследования, ведь сканирует моментально, в отличии от анализатора.</td>
    </tr>
    <tr>
      ...
      <td>Артефакты нужны ученым для извлечения из них очков исследований путем исследования узлов артефакта. На большинстве станций вы можете встретить по 2 артефакта на отдел. <p> <a href="/ru/guides/listofproducts"><span style="color: #7D512D;">Могут быть заказаны в карго.</span></a></td>
    </tr>
  </tbody>
</table>
...
anomaly-scanner.png"><p><strong>Сканер аномалий<p></strong></td>
      ...
      <td>При использовании на аномалии выдает о ней информацию, нужную для изменения ее статуса. Дает возможность связывать аномалию с сосудом.</td>
    </tr>
    <tr>
      <td><img class="big" height="100px" width="100px" src="/guides/science/anomalies/
...
anomaly-sync.png"><p><strong>Синхронизатор аномалий</strong><p></td>
    ...
    <tr>
      ...
      <td>Перчатка способная толкать аномалии и живых существ, использет заряды как источник энергии. Заряды можно получить поставив ядро внутрь перчатки ( 1 ядро - 5 зарядов ).</td>
    </tr>
    <tr>
...
cryptobiolin_pill.png"><p><strong>Таблетка токсина майндбрейкера<p></strong></td>
      <td>Таблетка убивающая все способности к псионике в съевшем ее существе.</td>
...
insulative_skullcap.png"><p><strong>Изолирующий череп<p></strong></td>
      ...
      <td>Более прочный защитник от псионических способностей, не разрушается от сильных воздействий, но может поджечь вас!</td>
    </tr>
    <tr>
...
glimmer_prober.png"><p><strong>Пробер мерцания<p></strong></td>
      ...
      <td><p>Проберы ловят колебания мерцания и преобразуют его в очки, но повышают уровень мерцания.<p><span style="color: red;">Опасен при высоком уровне мерцания, вызывает разряды молний или может взорваться!</span> </td>
    </tr>
    <tr>
      <td><img class="big" height="100px" width="100px" src="/guides/science/psionics/	
...
<table class="table-name">
  <thead>
    ...
    <tr>
      ...
      <td>При нажатии ЛКМ по объекту дает вам передвигать его в пространстве по одному. </td>
    </tr>
    <tr>
      <td><strong><img width="100" class="big" height="100 "src="/guides/science/other/weaponforcegun.png"><p>Силовая пушка</strong></td>
      <td>Манипулирует гравитацией вокруг объектов, чтобы манипулировать ими в пространстве!</td>
      <td>При нажатии ЛКМ по объекту дает вам передвигать его в пространстве по другому. </td>
    </tr>
    <tr>
