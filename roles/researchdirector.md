...
> Белый код
Белый код - код, объявляемый  в момент, в котором [мерцание](/guides/psionics) пресекло предел в 500Ψ. Вы должны всеми силами разобраться и избавиться от причин усиления сияния. 
{.is-info}
...
Вы - мистагог, Вам надо будет работать с псиониками, из-за чего вам изначально доступны способности для разрешения ситуаций, вызванных псиониками. Также вы можете улучшать и получать новые способности. Здесь представлены ваши способности, открытые с начала смены
