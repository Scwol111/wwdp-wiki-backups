...
<div style="display: flex; justify-content: center;">
  <div class="roles-passport sint">
    ...
    <div>
      <div><div><img src="/borggiffix2.gif" class="borgglav"></div></div>
      <div><div>
        <h1>Борг</h1>
...
Пример: Перед вами начинается драка между двумя ассистентами, исходя из этого закона вы обязаны вызвать службу безопасности и оказать помощь потерпевему. Вы можете использовать нелетальные методы взаимодействия для устранения конфликта. Постарайтесь обойтись без жертв среди членов экипажа. 
...
Пример: В защищённый отсек Главы начинает вламываться клоун. Вы обязаны вызвать службу безопасности, и при этом не допустить проникновение клоуна, желательно не насильственным методом. 
...
<button type="button" class="collapsible">
  <div>Syndicate assault (55 ТК NukeOps)</div>
</button>
<div class="content">
...
<button type="button" class="collapsible">
  <div>weapon cyborg module (5 ТК)</div>
</button>
<div class="content">
  <div style="text-align:center; overflow-x:auto;">Модуль, который можно купить в аплинке.
    <table class="tableimg">
      <tr>
        <th> Текстура </th>
        <th> Название </th>
