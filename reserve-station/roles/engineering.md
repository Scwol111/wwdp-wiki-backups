...
<!--  <div><a href="/roles/brigadier">Бригадир</a><a href="/roles/brigadier"><img src="/roles/brigadier.png" /></a></div>
  ...
  <div><div> Управляет инженерным отделом и следит за сохранностью станции, построит шаттл чтобы свалить, да побыстрее, прикрываясь фразами, вроде "чтобы был!", "запасной для <a href=/reserve-station/roles/cargo> отдела снабжения</a>!"</div></div>
