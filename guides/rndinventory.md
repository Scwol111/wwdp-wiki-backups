...
# Научный инвентарь
  В игре существует несколько отделов, каждый из которых выполняет свою роль в функционировании станции. Одним из таких отделов является РНД или же отдел исследований. Его инвентарь можно разделить на несколько галузей: 
...
Каждая часть РНД из списка очень важна для функционирования не только отдела, но и всей станции, а если точнее, ее целостности, но для их функционирования может понадобиться парочку предметов, про эти предметы статья и пойдет.
