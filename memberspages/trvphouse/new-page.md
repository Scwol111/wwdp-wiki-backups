...
<center>
  <div class="maincontainer">
    ...
    <button type="button" class="collapsible"><h2>Стандартные взаимодействия</h2></button>
    <div class="content">
    ...
    <button type="button" class="collapsible"><h2>Ближний бой</h2></button>
    <div class="content">
...
<button type="button" class="collapsible"><h2>Захват (Grab)</h2></button>
<div class="content">
  <p>Для активации захвата необходимо находиться в режиме Ближнего боя, который включается нажатием на иконку в хотбаре <img src="/guides/basics/harmoff.png" style="vertical-align: middle"> с помощью <kbd>ЛКМ</kbd> или простым нажатием клавиши <kbd>1</kbd>.</p>
  <p>В режиме боя, чтобы выполнить захват, нажмите <kbd>Ctrl</kbd> и нажмите <kbd>ЛКМ</kbd> по противнику. Захват может быть разных уровней:</p>
  <ul>
    <li><strong>SOFT</strong> — обычный захват, для освобождения нужно нажать на соответствующую кнопку.</li>
    <li><strong>HARD</strong> — позволяет бросить противника с помощью комбинации <kbd>Ctrl</kbd> + <kbd>Q</kbd>.</li>
    <li><strong>CHOKE</strong> — усиливает урон от броска.</li>
  </ul>
</div>
    ...
    <button type="button" class="collapsible"><h2>Взаимодействия активации (<kbd>E</kbd>)</h2></button>
    <div class="content">
    ...
    <button type="button" class="collapsible"><h2>Альтернативные взаимодействия (<kbd>Alt</kbd>+<kbd>ЛКМ</kbd>)</h2></button>
    <div class="content">
    ...
    <button type="button" class="collapsible"><h2>Использование в руке (<kbd>Z</kbd>)</h2></button>
    <div class="content">
      ...
      <ul>
        <li>Открывать банки с <a href="/guides/beverages">напитками</a>.</li>
        <li>Съесть <a href="/guides/food">пищу</a>.</li>
    ...
    <button type="button" class="collapsible"><h2>Передача предмета (<kbd>F</kbd>)</h2></button>
    <div class="content">
    ...
    <button type="button" class="collapsible"><h2>Перетаскивание</h2></button>
    <div class="content">
    ...
    <button type="button" class="collapsible"><h2>Передвижение больших предметов</h2></button>
    <div class="content">
      ...
      <ul>
        ...
        <li>Перетащите другого игрока в <a href="/guides/medicalequipment">мед сканер</a>, чтобы его там оставить.</li>
      </ul>
    </div>


    <button type="button" class="collapsible"><h2>Окно на <kbd>ПКМ</kbd></h2></button>
    <div class="content">
    ...
    <button type="button" class="collapsible"><h2>Меню взаимодействия (<kbd>ПКМ</kbd> по предмету в инвентаре, или в меню предмета)</h2></button>
    <div class="content">
    ...
    <button type="button" class="collapsible"><h2>Советы</h2></button>
    <div class="content">
    ...
    <button type="button" class="collapsible"><h2> Внимание</h2></button>
    <div class="content">
    ...
    <button type="button" class="collapsible"><h2> Оповещения</h2></button>
    <div class="content">
    ...
    <button type="button" class="collapsible"><h2> Панель действий</h2></button>
    <div class="content">
    ...
    <button type="button" class="collapsible"><h2> Кнопки сверху экрана</h2></button>
    <div class="content">
    ...
    <button type="button" class="collapsible"><h2> Прочее управление</h2></button>
    <div class="content">
      <ul>
    ...
    <button type="button" class="collapsible"><h2> Известные проблемы</h2></button>
    <div class="content">
      <h3> Дупликация взаимодействий</h3>
