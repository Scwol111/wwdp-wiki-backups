...
> Белый код
Белый код - код, объявляемый  в момент, в котором сияние пресекло предел. Вы должны всеми силами разобраться и избавиться от причин усиления сияния. 
{.is-info}
