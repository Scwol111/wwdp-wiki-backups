...
Добро пожаловать в увлекательный мир лингвистического хаоса станции SS14! Эта инструкция станет вашим верным спутником в освоении систем языков, которые царят на борту. Узнайте, как расшифровать бульканье слаймолюдов, что пытается сказать мышь.

Чтобы открыть меню языков, нажмите на кнопку <kbd>L</kbd> или <kbd>Д</kbd>, в зависимости от вашей клавиатуры.
<img src="/guides/language/l.png">
В языковом меню в верхней части экрана отображается выбранный вами язык. Здесь же представлены языки, которые вы знаете.
