...
<div id="main-crab">
  <div id="stupid-crabs">
    ...
    <div id="def-crab-text" style="display: none;"><b style="border-style: solid; background: linear-gradient(to top,rgba(41,6,6),rgba(32,5,5)); border-color: rgba(27,5,5); border: none 5px 3px 5px; padding: 20px 50px 10px 50px; border-radius: 8px; font-size: 30px;">Обычный хедкраб</b><strong><p style="font-size: 20px; margin-bottom: 10px">Они бежевого окраса. Они ничем не выделяются от других видов своего рода. Зато они красивые.</strong></div>
