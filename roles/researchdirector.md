...
> Белый код
Белый код - код, объявляемый  в момент, в котором сияние пресекло предел в 500. Вы должны всеми силами разобраться и избавиться от причин усиления сияния. 
{.is-info}
