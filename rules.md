...
<div id="rule-table">
  <p id="warn" class="t-red infobox danger-custom"><b>ДЛЯ ИГРЫ НА СЕРВЕРАХ WHITE DREAM ВАМ ДОЛЖНО БЫТЬ НЕ МЕНЕЕ 16 ЛЕТ. ПОЛЬЗОВАТЕЛИ, ПОДОЗРЕВАЕМЫЕ В ТОМ, ЧТО ИМ МЕНЬШЕ 16 ЛЕТ, БУДУТ ЗАБЛОКИРОВАНЫ ДО ДОСТИЖЕНИЯ ИМИ УСТАНОВЛЕННОГО ПРАВИЛАМИ СЕРВЕРА ВОЗРАСТА.</b></p>
  <br>
...
<ol id="rule-list">
<details open>
<summary>Не будь мудаком</summary>
  <ul class="ul-in-list">
...
Правила также продолжают действовать после конца раунда (манифеста).
  </ul>
</details>
<details open>
<summary>Выход из роли</summary>
  <ul class="ul-in-list">
...
<details open>
<summary>Нарушение игровой атмосферы</summary>
  <ul class="ul-in-list">
...
<ul style="margin-left: 32px">
  ...
  <li>Брейнрот - использование сленга несвойственного сеттингу станции и чрезмерных сокращений. Разрешено использовать традиционные названия ролей (ХОС, ХОП, СМО и т.д.).</li>
...
Внутриигровое имя персонажа должно быть написано в полной форме. Запрещены шуточные и глупые имена, а также очевидные отсылки на реальных личностей и известных персонажей. Для клоунов и мимов можно выбрать имя с более низкими требованиями.
...
<details open>
<summary>Метагейм</summary>
  <ul class="ul-in-list">

   <span class="t-red">Не распространяйте информацию о событиях текущего раунда в LOOC/OOC чатах и не используйте сторонние средства связи для координации действий в игре.</span>
   ...
   Любой персонаж после клонирования или пересадки мозга <span class="t-red">забывает</span> обстоятельства своей смерти.
...
<details open>
<summary>Ответственная игра за антагониста</summary>
  <ul class="ul-in-list">
  Задача антагонистов - сделать раунд интереснее и опаснее для остальных игроков в разумных пределах.<br><br>
  Выдаваемые агентам синдиката цели не являются ограничениями. Агент может реализовать любые свои идеи, кроме банального уничтожения всей станции или экипажа.
...
Если вы считаете, что не справляетесь со своими целями по ходу игры или не понимаете, что от вас требуется для её достижения - обратитесь к администрации за помощью через AHelp.

  </ul>
</details>
<details open>
<summary>Взаимодействие с антагонистами</summary>
  <ul class="ul-in-list">
...
Не стоит ставить целью своей игры победу над антагонистами. Это такие же игроки, цель которых сделать раунд интереснее для всех.
   ...
   Целенаправленная охота на антагонистов (валидхант) не будучи частью Службы Безопасности <span class="t-red">недопустима.</span>
...
<details open>
<summary>Нечестная игра</summary>
  <ul class="ul-in-list">
