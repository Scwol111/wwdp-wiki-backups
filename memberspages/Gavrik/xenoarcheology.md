...
<div class="infobox">
  <img src="/guides/xenoarcheology/skaner_uslov.gif" width="64"/> 
...
<div class="infobox"> 
  ...
  <p>Крушитель позволяет разрушать артефакты, получая осколки артефакта и активируя узел, на котором он находился в процессе преобразования. Однако мы не рекомендуем использовать эту функцию, если артефакт расположен на опасном узле.</p> 
</div>   
