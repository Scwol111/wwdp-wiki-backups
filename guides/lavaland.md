...
<h2><img style="vertical-align:middle" src="/roles/cargo/pickaxe.png"> Начало начал <img style="vertical-align:middle" src="/roles/cargo/pickaxe.png"></h2>
...
<figure class="table" style="text-align:center;">
  <table style="background-color:#ad5313;">
    <tbody>
      ...
      <tr>
        <th>
          <figure class="image"><img src="/guides/supply/lavaland/explorer_suit.png" sizes="" width="75%"></figure>
        </th>
        <th><strong>Костюм исследователя</strong></th>
        <th>Армированный костюм для работы в неблагоприятных условиях. Обеспечивает хорошую защиту от фауны, но бесполезен против бури. Укрепляется в 3 этапа пластинами голиафа по 5 штук на уровень. Можно временно заменить любым скафандром.</th>
      </tr>
      <tr>
        <th>
        ...
        <th>Брутально выглядящий противогаз, однако не более чем дыхательная маска. Ничтожно защищает от всех видов урона.</th>
      </tr>
      <tr>
        <th>
...
Азотный баллон</strong></th>
        <th>
          <p>Чтобы выжить снаружи дольше пары минут, вам понадобится кислородный баллон. Экипируйте его карман (если он аварийный) или на спину, чтобы иметь возможность правильно использовать его с вашим противогазом. Важно: азотом дышат только слаймолюды.</p>
        </th>
      </tr>
      <tr>
        <th>
        ...
        <th>Он и его различные вариации позволяют эффективно копать руду. Возможна установка обвесов, повышающих урон, скорострельность и дальность атаки.</th>
      </tr>
      <tr>
        <th>
      ...
      <tr>
        ...
        <th>Действительно специальная сумка для переноски руды. Вмещает достаточно много. Оснащена встроенным магнитом.</th>
      </tr>
      <tr>
        <th>
        ...
        <th>Показывает текущее местоположение в виде пары координат. Рекомендуется брать с собой в каждый поход, так как легко заблудиться.</th>
      </tr>
  		<tr>
        <th>
          <figure class="image"><img src="/guides/supply/lavaland/jaunter.png" width="60%"></figure>
        </th>
        <th><strong>Джаунтер</strong></th>
        <th>В случае падения в яму, телепортирует обратно на поверхность. Расходуется после использования.</th>
      </tr>
  		<tr>
        <th>
          <figure class="image"><img src="/guides/supply/lavaland/capsule.png" width="60%"></figure>
        </th>
        <th><strong>Капсула укрытия</strong></th>
        <th>Создаёт укрытие, в котором можно пережить бурю. Работает только в Лаваленде.</th>
      </tr>
    </tbody>
  </table>
</figure>
...
Добыв руду, не забудьте отправить её в переработчик. Закончив плавить руды ОБЯЗАТЕЛЬНО снимите очки, которые пойдут на вашу ID-карту - иначе их возьмут ваши коллеги. Переплавленную руду можете сунуть в автолат, чтобы сделать её доступной для всей станции. (убедитесь, что он подключен к блюспейс хранилищу).

Полученные очки можно потратить в утильмаге, где можно достать расходники, новые шахтёрские инструменты, улучшения, броню и даже огнестрельное оружие.
...
Лаваленд полон и других структур: разрушенные убежища, дендрарий, разбитые шаттлы и многое другое.
...
Список:
- Сталагмит - живое зубоподобное существо, призывающее всех остальных. Со временем может дать сундук некрополиса
...
- Магматическая рука - слайм, состоящий из слизи.
