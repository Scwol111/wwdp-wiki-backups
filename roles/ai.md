...
Искусственный интеллект (ИИ) — ключевая роль на станции SS14. ИИ контролирует все электронные системы, если их проводка не повреждена.  В зависимости от развития событий ИИ способен повлиять на работу всей станции.
...
1. Чтобы изменить законы, необходим сотрудник с уровнем доступа «Научный Руководитель». После того как консоль будет разблокирована с помощью этого доступа, сотрудник должен вставить одну из известных плат законов в специальный позолоченный слот в консоли для загрузки ИИ.
1. Если будет использован [ЕМАГ](/ru/guides/emag) или способность [Неисправность](/ru/roles/revenant)  на борге, то произойдет взлом и свод законов сменится на **особый**. 
1. В ходе активации случайного события Ионный Шторм имеется шанс на изменение законов у Искусственного Интеллекта.
