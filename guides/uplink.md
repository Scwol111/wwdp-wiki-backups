...
<td>Да</td>
    ...
    <tr>
      ...
      <td>
        ...
        <p>Так же в пистолет встроен глушитель, он использует патроны, от которых не остаются гильзы. Идеален для скрытных убийств.</p>
      </td>
<td>Да</td>
    </tr>
    <tr>
    ...
    <p><span>- Отнимает <b class="percent">60%</b> <b style="color: yellow;">Теплового</b> урона.</span></p>
        <p>Имеет заряд. В случае его разряда - заряжается за 15 секунд.</p>
      </td>
   ...
   <!-- <tr>
    ...
    <tr>
      ...
      <td>
        ...
        <p>При нажатии <kbd>ПКМ</kbd> во включеном харме телепортирует владельца на расстояние до 6 тайлов. При телепортации в цель - оглушает ту на небольшой промежуток времени.</p>
      </td>
<td>Нет</td>
    </tr>
    <tr>
...
<td>Да</td>
    ...
    <tr>
      ...
      <td>
        ...
        <p>Урон от выстрела - <b style="color: red;">16</b> единиц урона  <b style="color: yellow;">уколами</b>.</p>
...
дозвуковых патрон .30.</p>
   <td>Да      </td>
      ...
      <td>
        ...
        <p> При выстреле выпускает 6 пуль. Одна пуля при попадании наносит <b style="color: red;">13</b> единиц урона <b style="color: yellow;">уколами</b>.</p>
        <p>Скорострельность <b style="color: yellow;">2.0</b> в секунду.</p>
   <td>Да      </td>
    </tr>
    <tr>
      ...
      <td>
        ...
        <p>Урон от выстрела - <b style="color: red;">140</b> единиц урона <b style="color: yellow;">уколами</b>.</p>
   ...
   <td>Да      </td>
    ...
    <tr>
      ...
      <td>
        ...
        <p>Обойма - 3 заряда. </p>
        <p>Осколочный создает взрыв на 5-7 тайлов и наносит урон в размере <b style="color: red;">90</b> единиц. Крайне полезен для массовых повреждений, есть риск задеть своих (или же самого себя, если стрелять слишком близко с целью поражения!).</p>
        <p>Фугасный создает взрыв на 4-5 тайлов и наносит урон в размере <b style="color: red;">150</b> единиц. Наиболее полезен для быстрого убийства небольшой группы лиц.</p>
    ...
    <tr>
      ...
      <td>
        ...
        <p>Урон от попадания - <b style="color: red;">19</b> единиц урона <b style="color: yellow;">уколами</b></p>
        <p>Скорострельность <b style="color: yellow;">8.0</b> в секунду.</p>
...
<td>Да</td>
    ...
    <tr>       
      ...
      <td>4 ТК</td>
      <td>
        <p>Незаметно воруйте из карманов и повышайте навык воровства с помощью этих новых модных перчаток, которые выглядят совсем как обычные! Обладают технологией хамелеона.</p>
      </td>
<td>Да</td>
    </tr>
    <tr>    
...
<center>
  <div class="table-wrapper">
    ...
    <tr>
      ...
      <td>20 ТК</td>
      <td>
        <p>О боже, благослови эту ручную гранату, дабы смогла она покрошить врагов на мелкие кусочки! Граната при запуске создаёт сильнейший взрыв в огромном радиусе.</p>
        <p>Доступно <a href="/roles/priest" class="is-internal-link is-valid-page">священнику</a>.</p>
      </td>
    </tr>
...
<center>
  <div class="table-wrapper">
    ...
    <tr>
      ...
      <td>1 ТК</td>
      <td>Стильный зелёный полосатый шарф Синдиката. Идеальный зимний аксессуар для тех, у кого обострённое чувство моды, и тех, кто просто в настроении что-нибудь украсть.</td>
    </tr>
    <tr>
      <td>
      ...
      <td>1 ТК</td>
      <td>Стильный красный полосатый шарф Синдиката. Идеальный зимний аксессуар для тех, у кого обострённое чувство моды, и тех, кто просто в настроении что-нибудь украсть.</td>
    </tr>
    <tr>
      <td>
    ...
    <tr>
      ...
      <td>4 ТК</td>
      <td>Револьвер, использующий пистоны, не наносит урон.</td>
    </tr>
    <tr>
      <td>
