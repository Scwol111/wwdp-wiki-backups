...
anomaly-sync.png"><p><strong>Синхронизатор аномалий</strong><p></td>
    ...
    <tr>
      ...
      <td>Перчатка, способная толкать аномалии и живых существ, использует заряды как источник энергии. Заряды можно получить поставив ядро внутрь перчатки ( 1 ядро - 5 зарядов ).</td>
    </tr>
    <tr>
...
cryptobiolin_pill.png"><p><strong>Таблетка токсина майндбрейкера<p></strong></td>
      <td>Даже самая малая доза вещества внутри таблетки способна убить любую псионическую силу.</td>
...
<div class="table-name tab"><table>
  <thead>
    <tr>
      <th>Раздатчик</th>
      <th>Содержимое</th>
