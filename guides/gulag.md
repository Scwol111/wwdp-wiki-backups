...
<div class="warning-banner">
  <h2>Внимание!</h2>
  <p>В данной статье рассматриваются игровые механики, которые либо ещё не были реализованы, либо больше не будут переноситься в связи с глобальными изменениями в билде сервера.</p><p>
</div>
</center>
