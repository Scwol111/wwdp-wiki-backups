...
<center><table class="rnd">
  <thead>
    ...
    <tr>
      ...
      <td>В качестве <a href="/role/traitor">предателя</a> это очень полезный инструмент по разным причинам: от кражи, ljели в космосе и оставления ее умирать.</td>
    </tr>
    <tr>
