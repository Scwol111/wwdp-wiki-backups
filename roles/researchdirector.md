...
На станции аномалия, угрожающая подрывом брига, из-за высокого уровня [мерцания](/guides/glimmer) может быть объявлен [белый код](/guides/responseprotocols), инженеры не могут выполнить цель из-за отсутствия соответствующих технологий - Вы не должны этого допустить! Следите за уровнем мерцания и предпринимайте необходимые меры. Следите за получением очков науки, наличием необходимых ресурсов, и стабильностью [аномалий](/ru/guides/anomalies) на станции. Назначьте научным ассистентам наставников, чтобы не прохлаждались в баре!

<!-- Следи за [ИИ станции](/roles/ai)!
Следите за поведением ИИ, боргов, изменением их законов при различных событиях.
Вы несете ответственность за действия ИИ. Он может запросить смену законов. Платы законов обычно находятся в вашем шкафу, или в хранилище ИИ, (рядом с его ядром) там же где и консоль загрузки законов. -->
...
*Будет неплохо, если вы, или назначенный вами учёный или инженер заменит ваши автолаты, протолаты и прочее на их улучшенную версию. Вы будете тратить меньше ресурсов!*



> Белый код
Белый код - код, объявляемый  в момент, в котором [мерцание](/guides/glimmer) пресекло предел в 500Ψ. Вы должны всеми силами разобраться и избавиться от причин усиления сияния. 
{.is-info}

Вы должны проследить чтобы ваш персонал работал на пресечение эскалации этой ситуации. Вы обязаны избавить псиоников от своих способностей навсегда - в добровольно-принудительном порядке.
<!-- указать о компьютере с реестром псиоников и т.п -->
...
<tr>
<td><a href=/guides/rndinventory#a11><img src="/armor/rdspacesuit.png" href=/guides/rndinventory alt="Скафандр мистигога" width="64" height="64"><a href=/guides/rndinventory#a11><br>NT-45e - "София" </a></td>
...
<td>Управляет дверями научного отдела.</td>
</tr>
<tr>
...
<tr>
<td><img src="/guides/rd_and_something/bodybag32.gif" width="64" height="64" img><center>Радиационные мешки для трупов</center></td>
<td>Мешки, позволяющие транспортировать облученные трупы без вреда для окружающих. Замедляет гниение</td>
</tr>
<tr>
...
Вы - мистагог, Вам надо будет работать с псиониками, из-за чего вам изначально доступны способности для разрешения ситуаций, вызванных псиониками. Также вы можете улучшать и получать новые способности. Здесь представлены ваши способности, открытые с начала смены. Больше - на [этой странице](/guides/psionics#aa1)
...
<!--  <tr>
      ...
      <td>Сила позволяющая узнать, есть ли поблизости другие псионики. Также она способна сообщить вам, о появившихся поблизости сильных ноосферные колебаний.</td>
    </tr> -->
    </tbody>
  </table>
</center>
