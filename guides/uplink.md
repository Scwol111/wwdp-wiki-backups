...
<td>Да</td>
    ...
    <tr>            
         <td>
        <img src="/guides/uplinknew/rainbow.png">
        <p>Набор хамелеона</p>
      </td>
      <td>4 ТК</td>
      <td>
        <p>Рюкзак, полный предметов-хамелеонов, позволяющую вам маскироваться их под практически все, что есть на станции, и даже больше!</p>
      </td>
<td>Да</td>
    </tr>
    <tr>  
...
<center>
 ...
 <tr>
      ...
      <td>6 ТК</td>
      <td>
        <p>Ультимативный ответ энергетическому оружию: Отключает дизейблеры, электрошокеры, разряжает лазерные пушки! Содержит 3 ЭМИ- гранаты и ЭМИ-имплант. Примечание: не выводит из строя настоящее огнестрельное оружие.</p>
   <td>Да      </td>
    </tr>
 <tr>
      <td>
