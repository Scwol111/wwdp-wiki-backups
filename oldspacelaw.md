...
<div class="warning-banner">
  <h2> Архив  </h2>
  <p>Это старая версия космического закона, перемещенная в архив, <a href="/spacelaw">клик для перехода на актуальную версию</a>.</p><p><i>Не шумите здесь</i></p>
</div>
</center>
