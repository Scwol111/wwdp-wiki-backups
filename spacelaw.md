...
<p>Каждый обвиняемый имеет право на помощь в защите своих прав и свобод. Для этого на станции работают Адвокат, Прокурор и Верховный судья составе отдела Юстиции.</p>
...
<div class="table-container"><table style="text-align:center;">
    <tbody>
      ...
      <tr>
        ...
        <th style="background-color:rgb(150, 53, 53); color:white;"> Действия, приводящие к серьёзному нарушению работы одного из отделов или всей станции в целом. Примеры включают вывод из строя ключевых элементов энергосети (например, путём повреждения подстанции) или уничтожение боргов.</th>
