...
Т.к. у скелета нет органов и крови, то обычными способами, такими как таблетки или шприцы, его не вылечить. В приницпе единственный урон, который он может получить - физический и механический. Механический можно вылечить только <a href="/guides/medicalequipment">наборами от ушибов</a>, а физический - молоком. Но просто выпить его не получится по понятным причинам, поэтому нужно себя им облить. Сделать это можно вылив на себя молоко из какой-либо ёмкости или, например, подскользнуться на луже молока, из-за чего некоторое количество впитается в кости при падении.

Молоко можно попросить у <a href="/roles/chef">поворов</a> или заказать в <a href="/roles/supplydepartment">отделе снабжения</a>. 
<div class="table"></div>