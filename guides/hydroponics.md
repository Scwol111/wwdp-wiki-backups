...
<table class="ser">
  ...
  <tbody>
    ...
    <tr>
      <td>Кудзу
      <td>3,6%
      <td>Растение заражается кудзу - сорняком, который будет постоянно регенерироваться, и если за ним не уследить, то оно выйдет наружу из лотка и начнут плести лианы. Так как он является геном, лучше всего избавиться от него методом селекции.
    </tr>
    <tr>
      <td>Отсутствие семян
      <td>3,6%
    ...
    <tr>
      ...
      <td>3,6%
      <td>Увеличивает длительность жизни. (Мин значение - +10 мин. , Макс - +80 мин.)
    </tr>
    <tr>
      <td>Серийность
      <td>3,6%
