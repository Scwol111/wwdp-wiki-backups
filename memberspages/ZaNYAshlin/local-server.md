...
<div>
  <div id="header" class="headtext" style="display: flex">
    <div id="grabZone"></div>
    <div id="name" style="display: flex; cursor: default">>_ <span id="r_icon" display="block">cmd - type local_server.txt</span></div>
