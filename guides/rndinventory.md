...
Каждая часть РНД из списка очень важна для функционирования не только отдела, но и всей станции, а если точнее, ее целостности, но для их функционированния может понадобиться парочку предметов, про эти предметы статья и пойдет.
