...
<div>
  ...
  <h2><center>Обновление локального сервера</center></h2>
  Так как разработка билда не стоит на месте, то для ознакомления с новыми изменениями придётся обновлять установленную сборку.
