...
Каждая часть РНД из списка очень важна для функционирования не только отдела, но и всей станции, а если точнее, ее целостности, но для их работы может понадобиться парочка предметов, про эти предметы ⬇️⬇️⬇️ЧИТАТЬ НИЖЕ⤵️⤵️⤵️
...
<table class="table-name">
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>Контейнер оснащенный некоторыми технологиями и сделанный из специального сплава, способного содержать артефакты.</td>
...
skaner_uslov.gif"><p><strong>Сканер узлов</strong><p> </td>
      <td>Анализируя самые маленькие вибрации в артефакте, определяет текущий узл.</td>
...
ape.png"><p><strong>М.А.К.А.К.</strong></td>
      ...
      <td>Пушка способная создавать 4 вида частиц, каждая из которых выполняет свою функцию, начиная от кормежки аномалии, заканчивая ее ликвидацией.</td>
    </tr>
    <tr>
      <td><img class="big" height="100px" width="100px" src="/guides/science/anomalies/	
